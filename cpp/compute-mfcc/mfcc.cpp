...
public:
    ...
    myMFCC(int sampFreq=16000, int nCep=12, int winLength=25, int frameShift=10, int numFilt=40, double lf=50, double hf=6500) {
        ...
        winLengthSamples   = winLength;  // winLength in milliseconds
        frameShiftSamples  = frameShift; // frameShift in milliseconds
    ...
    void processFrame(int16_t* samples, size_t N) {
